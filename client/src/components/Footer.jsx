...
export default function Footer() {
  return (
    <footer className="bg-d0 border-t border-d3 text-white">
      <div className="container-x py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-display font-bold text-base">Dolananpoto Studio</span>
            </div>
            ...
            <div className="flex gap-2">
              {[
                { icon: Instagram, href: 'https://instagram.com/dolananpoto', hov: 'hover:bg-pink/30 hover:text-pink' },
                { icon: Youtube,   href: 'https://youtube.com/@dolananpoto',  hov: 'hover:bg-red-500/30 hover:text-red-400' },
                { icon: MessageCircle, href: 'https://wa.me/6281234567890', hov: 'hover:bg-emerald-500/30 hover:text-emerald-400' },
                { icon: Mail,      href: 'mailto:hello@dolananpoto.com',       hov: 'hover:bg-mint-DEFAULT/30 hover:text-mint-DEFAULT' },
              ...
              <a href="https://tiktok.com/@dolananpoto" target="_blank" rel="noopener noreferrer"
          ...
          {[
            ...
            { title: 'Contact',  links: ['📱 0812-3456-7890', '✉️ hello@dolananpoto.com', '📍 Sidoarjo & Surabaya', '🕐 Buka 7 hari, 09–21'] },
          ].map(col => (
            <div key={col.title}>
        ...
        <div className="border-t border-d3 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-zinc-600">
          <span>© {new Date().getFullYear()} Dolananpoto Studio. All rights reserved.</span>
