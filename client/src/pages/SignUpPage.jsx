    ...
    <div className="min-h-screen bg-[#F0FDFB] flex items-center justify-center px-5 pt-16">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display font-bold text-2xl text-main mb-1">Buat Akun</h1>
        ...
        <div className="bg-white border border-[#C5F0EA] rounded-2xl p-6">
          ...
          <form onSubmit={submit} className="space-y-4">
            <div>
              <label htmlFor="signup-name" className="block text-sm font-medium text-main mb-1.5">Nama Lengkap</label>
              <input
                id="signup-name"
            ...
            <div>
              <label htmlFor="signup-email" className="block text-sm font-medium text-main mb-1.5">Email</label>
              <input
                id="signup-email"
            ...
            <div>
              <label htmlFor="signup-password" className="block text-sm font-medium text-main mb-1.5">Password</label>
        ...
        <p className="text-center text-sm text-sub mt-5">
          Sudah punya akun?{' '}
          <Link to="/masuk" className="text-mint-DEFAULT font-semibold hover:underline">Masuk</Link>
        </p>
      </div>
    </div>
  )
